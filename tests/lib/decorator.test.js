...
describe('lib/decorator', () => {
  ...
  describe('Decorator::constructor', () => {
    ...
    it('Should be an instanceof Decorator after initialized', () => {
        (new Decorator({mchid: '', serial: '', privateKey: '', certs: {'any': undefined}}))
    ...
    it('Should have tow in-hidden symbol properties(Symbol(XML PAYLOAD), Symbol(JSON PAYLOAD)) after initialized', () => {
        const instance = new Decorator({mchid: '', serial: '', privateKey: '', certs: {'any': undefined}})
  ...
  describe('Decorator::defaults', () => {
    it('property `defaults` should be static', () => {
      ...
      should((new Decorator({mchid: '', serial: '', privateKey: '', certs: {'any': undefined}})).defaults).be.Undefined()
    })
  })
  ...
  describe('Decorator::withDefaults', () => {
    it('Function `withDefaults` should be static', () => {
      ...
      should((new Decorator({mchid: '', serial: '', privateKey: '', certs: {'any': undefined}})).withDefaults).be.Undefined()
    })
  })
  ...
  describe('Decorator::xmlBased', () => {
    it('Function `xmlBased` should be static', () => {
      ...
      should((new Decorator({mchid: '', serial: '', privateKey: '', certs: {'any': undefined}})).xmlBased).be.Undefined()
    })
  })
  ...
  describe('Decorator::jsonBased', () => {
    it('Function `jsonBased` should be static', () => {
      ...
      should((new Decorator({mchid: '', serial: '', privateKey: '', certs: {'any': undefined}})).jsonBased).be.Undefined()
    })
  })
})
