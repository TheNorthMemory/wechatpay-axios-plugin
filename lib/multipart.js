...
class Multipart extends Readable {
  ...
  /**
   * Formed data wrapped by {@link Multipart#boundary}
   *
   * @param {string} name - The field name
   * @param {string|Buffer|ReadStream} value - The value
   * @param {string} [filename] - Optional filename, when provided, then append the `Content-Type` after of the `Content-Disposition`
   ...
   * @param {string} name - The field name
   *
   * @return {string|Buffer|ReadStream} value - The value
   */
   ...
   * @param {string} name - The field name
   *
   * @return {string|Buffer|ReadStream} value(s) - The value(s)
   */
   ...
   *
   * @return {Array<string, string|buffer|ReadStream>} - An IteratorLike key/value pairs.
   */
   ...
   *
   * @return {Array<string|Buffer|ReadStream>} - An IteratorLike value array.
   */
   ...
   *
   * @return {object<file:string, sha1:string>} - The `meta{file,sha1}` information.
   */
  toJSON() { return this.has('meta') ? JSON.parse(this.get('meta')) : null; }

  /**
   * {@link Multipart#entries}
   */
  get [iterator]() { return this.entries(); }
...
let FormData;
try {
  /* eslint-disable-line global-require, import/no-unresolved, import/no-extraneous-dependencies */
