const { createHash, createHmac, timingSafeEqual, createSecretKey, KeyObject, } = require('crypto');
...
class Hash {
  ...
  static isKeyObject(thing) { return (thing instanceof KeyObject) && ['secret'].includes(thing.type); }

  static keyObjectFrom(thing) { return createSecretKey(thing); }
   ...
   * @param {string|KeyObject} [key] - The secret key.
