...
class Transformer {
  ...
  get signer() {
    ...
    return function signer(data) {
      ...
      if (utils.isObject(this.merchant)) { Reflect.deleteProperty(this, 'merchant'); }
      ...
      if (methodIsGet) { Reflect.set(this, 'params', inter); return data; }

      return Object.fromEntries(inter.entries());
    };
  }
