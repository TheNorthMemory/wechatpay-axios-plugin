...
class Transformer {
  ...
  static signer(data) {
    ...
    Transformer.mchid === undefined || assert.ok(
   ...
   * @param {string|buffer} xml - XML string or `bufferArray`
   * @return {object|buffer} - Parsed as object for xml, buffer for `bufferArray`
   */
  static toObject(xml) {
